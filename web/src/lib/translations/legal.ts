...
export const LEGAL: Record<string, Translation> = {
  ...
  "Det är du som säljer möbeln, och det är du som ansvarar för allt som står i annonsen — skickbetyget, skadelistan, måtten, modellen och bilderna. Texten och bedömningen du får av oss är ett förslag som en modell skrivit ur dina bilder, och ett förslag är inte ett påstående förrän du gjort det till ditt.": {
    en: "You are the one selling the furniture, and you are responsible for everything the listing says — the condition grade, the damage list, the measurements, the model and the photos. The text and the assessment you get from us are a suggestion written by a model from your photos, and a suggestion is not a claim until you have made it your own.",
    fr: "C'est vous qui vendez le meuble et vous qui répondez de tout ce que dit l'annonce — la note d'état, la liste des dommages, les dimensions, le modèle et les photos. Le texte et l'évaluation que nous vous fournissons sont une proposition rédigée par un modèle à partir de vos photos, et une proposition ne devient une affirmation qu'une fois que vous l'avez faite vôtre.",
  },
  "Du är därför skyldig att läsa igenom varje förslag som tagits fram automatiskt och rätta det som inte stämmer innan du lägger ut annonsen. Saknas en skada i listan lägger du till den; står det en skada som inte finns tar du bort den; stämmer inte modellen eller måtten ändrar du dem. Att publicera annonsen är ditt intyg om att den stämmer med möbeln du säljer — att förslaget kom från oss är inte en ursäkt efteråt.": {
    en: "You are therefore obliged to read through every automatically generated suggestion and correct whatever is wrong before you publish the listing. If damage is missing from the list, you add it; if damage is listed that isn't there, you remove it; if the model or the measurements are wrong, you change them. Publishing the listing is your assurance that it matches the furniture you are selling — that the suggestion came from us is not an excuse afterwards.",
  ...
  "Köpet är mellan dig och köparen": { en: "The purchase is between you and the buyer", fr: "L'achat se fait entre vous et l'acheteur" },
  "Juridiskt sker köpet mellan två privatpersoner: du som säljare och den som köper möbeln. Loopa förmedlar affären — vi bygger annonsen, tar emot betalningen och ordnar leveransen — men vi är inte säljare och köper inte möbeln av dig. Det är köplagen som gäller mellan er, inte konsumentköplagen, eftersom ingen av er handlar i egenskap av företag.": {
    en: "Legally, the purchase takes place between two private individuals: you as the seller and the person buying the furniture. Loopa brokers the deal — we build the listing, receive the payment and arrange the delivery — but we are not the seller and we do not buy the furniture from you. The Swedish Sale of Goods Act governs between the two of you, not the Consumer Sales Act, since neither of you is acting as a business.",
    fr: "Juridiquement, l'achat a lieu entre deux particuliers : vous en tant que vendeur et la personne qui achète le meuble. Loopa sert d'intermédiaire — nous créons l'annonce, encaissons le paiement et organisons la livraison — mais nous ne sommes pas le vendeur et ne vous achetons pas le meuble. C'est la loi suédoise sur la vente (köplagen) qui s'applique entre vous, et non la loi sur la vente aux consommateurs, puisque aucun de vous n'agit en qualité de professionnel.",
  },
  "Det finns ingen ångerrätt.": { en: "There is no right of withdrawal.", fr: "Il n'existe aucun droit de rétractation." },
  "Ångerrätten i distansavtalslagen gäller köp från en näringsidkare, och ett köp mellan två privatpersoner är inte det. En köpare kan alltså inte lämna tillbaka en möbel för att den inte passade, inte gick in genom dörren eller inte såg ut som hemma hos någon annan. Köpet är slutgiltigt när det är genomfört.": {
    en: "The right of withdrawal under the Distance Contracts Act applies to purchases from a trader, and a purchase between two private individuals is not one. A buyer therefore cannot return a piece because it didn't fit, didn't get through the door or didn't look the way it did in someone else's home. The purchase is final once it has gone through.",
    fr: "Le droit de rétractation prévu par la loi sur les contrats à distance vise les achats auprès d'un professionnel, ce que n'est pas un achat entre deux particuliers. Un acheteur ne peut donc pas retourner un meuble parce qu'il ne convenait pas, ne passait pas la porte ou n'avait pas l'allure qu'il avait chez quelqu'un d'autre. L'achat est définitif une fois conclu.",
  },
  "Om annonsen inte stämde": { en: "If the listing was wrong", fr: "Si l'annonce était inexacte" },
  "Visar det sig att möbeln inte är den annonsen beskrev — en skada som inte fanns med, ett skick som inte höll, en annan modell eller andra mått — har köparen rätt att skicka tillbaka den och få betalt tillbaka. Det är den enda vägen tillbaka som finns, och den öppnas av att annonsen var fel, inte av att köparen ändrat sig.": {
    en: "If the furniture turns out not to be what the listing described — damage that wasn't mentioned, a condition that didn't hold up, a different model or different measurements — the buyer is entitled to send it back and get their money back. That is the only way back that exists, and it is opened by the listing being wrong, not by the buyer changing their mind.",
    fr: "S'il s'avère que le meuble n'est pas celui décrit dans l'annonce — un dommage non mentionné, un état qui ne correspond pas, un autre modèle ou d'autres dimensions — l'acheteur a le droit de le renvoyer et d'être remboursé. C'est le seul retour possible, et il est ouvert par l'inexactitude de l'annonce, non par un changement d'avis de l'acheteur.",
  },
  "Returen kostar en fraktsträcka, och den står du för:": {
  ...
  "Det här är också hela skälet till att förslagen ska redigeras och inte bara godkännas. En skada du lät stå kvar oredigerad i annonstexten är en retur du betalar för.": {
    ...
    fr: "C'est aussi toute la raison pour laquelle les propositions doivent être modifiées et non simplement validées. Un dommage laissé tel quel dans le texte de l'annonce est un retour que vous payez.",
  },
  ...
  "Tjänsten tillhandahålls i befintligt skick. Vi ansvarar inte för indirekt skada, utebliven vinst eller för att en möbel såldes för mindre än du hoppats. Ingenting i de här villkoren begränsar det ansvar som inte får begränsas enligt tvingande lag — är du konsument gäller dina rättigheter mot oss enligt konsumentlagstiftningen oavsett vad som står här. Det gäller din relation till Loopa som tjänst; själva köpet av möbeln sker mellan dig och köparen och styrs av köplagen, som beskrivet ovan.": {
    en: "The service is provided as is. We are not liable for indirect damage, lost profit or for a piece selling for less than you hoped. Nothing in these terms limits liability that may not be limited under mandatory law — if you are a consumer, your rights against us under consumer legislation apply regardless of what is written here. That concerns your relationship with Loopa as a service; the purchase of the furniture itself takes place between you and the buyer and is governed by the Sale of Goods Act, as described above.",
    fr: "Le service est fourni en l'état. Nous ne répondons pas des dommages indirects, du manque à gagner ni du fait qu'un meuble se soit vendu moins cher qu'espéré. Rien dans les présentes conditions ne limite une responsabilité qui ne peut l'être en vertu du droit impératif — si vous êtes consommateur, vos droits à notre égard au titre de la législation sur la consommation s'appliquent quoi qu'il soit écrit ici. Cela concerne votre relation avec Loopa en tant que service ; l'achat du meuble lui-même a lieu entre vous et l'acheteur et relève de la loi sur la vente, comme décrit ci-dessus.",
  },
